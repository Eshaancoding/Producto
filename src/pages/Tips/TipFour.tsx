    ...
    return (
        <Tip 
            ...
            list={
                ...
                "There are bad things that will inevitable happen. But you have to prepare for it. You have to be prepared when someone makes fun of you. You have to be prepared when you feel insecure. You have to be prepared when you are not the best of all time. You may be the only black, white, Asian, Latino, or any other identity in a given situation. And there will be times when you feel alone. But you have to accept those moments. You have to feel the pain, and push towards it."]
            } 
            prevHref="/TipThree"
            nextHref="/TipFive"
        />
