import { IonTextarea, IonCard, IonLabel, IonPage, IonTitle, IonContent, IonButton} from '@ionic/react';
        ...
        <IonPage>
            <IonContent>
                ...
                <IonCard className='card' style={{ margin: 20 }}>
                    <IonLabel><span className="highlight">How did you feel after consulting the Accountability Mirror? What are the small steps that you are held accountable?</span></IonLabel>
