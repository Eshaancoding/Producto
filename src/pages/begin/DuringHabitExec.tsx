...
const DuringHabitExec: React.FC = () => {
    ...
    function ContinueClick () {
        if (color == "primary") history.replace("/AfterHabitExec")
    }
    ...
    return (
        <IonPage>
            <IonContent id="Content">
                <CloseButton small />
                <IonText> <p id="CustomTitle"> Write down about what is the sequence of steps involved in that execution of the habit</p> </IonText>
...
export default DuringHabitExec; 